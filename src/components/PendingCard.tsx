...
export function PendingCard({ count }: PendingCardProps) {
  return (
    <Card className="card-enterprise bg-warning/10 border-warning/30 shadow-[0_0_15px_hsl(var(--warning)/0.2)] max-w-xs">
      ...
      <CardContent className="pt-1">
        <div className="text-center">
          <span className="text-lg font-bold text-warning">{count}</span>
        </div>
      </CardContent>
    </Card>
  );
